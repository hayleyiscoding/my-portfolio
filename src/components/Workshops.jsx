              ...
              <div className="flex items-center">
                ...
                <div className="w-full">
                  <input
                    ...
                    className=" h-8 mt-1 bg-black border border-transparent text-white text-xs rounded-lg block w-full pl-3 p-4  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Search"
                    required
                  />
                </div>
                ...
                <table className="min-w-full lg:divide-gray-200 lg:divide-y">
                  ...
                  <tbody className="">
                    {filteredWorkshops.map((workshop) => (
                      <tr key={workshop.id}>
                        <td className="px-4 py-4 text-sm font-semibold text-white align-top lg:align-middle whitespace-nowrap">
                          <div className="flex items-center">
                            {workshop.title}
                          </div>

                          <div className="mt-1 space-y-2 font-light pl-11 lg:hidden">
                            <div className="flex items-center">
                            ...
                            <td className="hidden px-4 py-4 lg:table-cell whitespace-nowrap">
                              <div className="flex items-center space-x-4">
                                <a
                                  href={workshop.url}
                                  target="_blank"
                                  className="inline-flex items-center px-10 py-2 text-sm font-light text-white transition-all duration-200 bg-custom-red border border-1 border-white rounded-md shadow-sm focus:outline-none hover:text-white hover:opacity-90 focus:ring-2 focus:ring-offset-1 focus:ring-white"
                                >
                                  Visit
                                </a>
                              </div>
